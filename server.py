...
#             if database_Username_Data.get(username, None) != None:
#                 reply = ServerCommunication.form_invalid_reply()
#                 sock.send(reply.encode())
#                 return buffer
...
#                 database_Username_Data[username.decode()] = user_data
#                 database_Id_Username[userId] = username.decode()
...
#                 reply = ServerCommunication.form_invalid_reply()
#                 sock.send(reply.encode())
#                 print("<INVALID SETUP REQUEST>")
#     if (setup_command := data.get(COMMAND_VALIDATE, None)) != None and setup_command == REQUEST:
#         userId = int(data.get(HEADER_USER_ID, None))
#         if (username := database_Id_Username.get(userId, None)) != None and (user_data := database_Username_Data.get(username, None)) != None:
